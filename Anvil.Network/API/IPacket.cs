...
[PublicAPI]
public interface IPacket<in TReader, in TWriter> where TReader : IPacketReader where TWriter : IPacketWriter
{
    /// <summary>
...
/// </summary>
[PublicAPI]
public interface IPacket : IPacket<IPacketReader, IPacketWriter>
{
}