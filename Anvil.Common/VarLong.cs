...
/// <summary>
/// Provides static methods for reading and writing variable-length integers that are up to 10 bytes from both streams
/// and buffers.
/// </summary>
[PublicAPI]
...
{
    /// <summary>
    /// Encodes the given <paramref name="value"/> to a variable-length integer up to 10 bytes long, and writes it to
