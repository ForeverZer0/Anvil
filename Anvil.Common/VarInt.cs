...
public static class VarInt
{
    ...
    public static int Write(Span<byte> buffer, int value, bool zigzag = false)
    {
        var v = zigzag ? value : (int) VarIntUtil.EncodeZigZag(value, 32);
        return VarIntUtil.Encode(buffer, Unsafe.As<int, uint>(ref v));
    }
